...
}, function (_, __, profile, done) { return __awaiter(void 0, void 0, void 0, function () {
    var user, email, username, googleId, newUser, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, user_service_1["default"].findUserPerGoogleId(profile.id)];
            case 1:
                user = _a.sent();
            ...
            case 2:
                ...
                googleId = profile.id;
                return [4 /*yield*/, user_service_1["default"].createGoogleUser(username, email, googleId)];
            case 3:
                newUser = _a.sent();
                done(null, newUser);
                _a.label = 4;
...
passport_1["default"].deserializeUser(function (id, done) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_service_1["default"].findUserPerId(id)];
            case 1:
                user = _a.sent();
                done(null, user);
                return [3 /*break*/, 3];
