...
var controllerAuth = {
    signInForm: function (_, res) {
        res.render("auth/auth-form", { errors: null });
    },
    signIn: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, user, match, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, user.comparePassword(password, user.local.password)];
                case 2:
                    match = _b.sent();
                    if (match) {
                        req.login(user);
